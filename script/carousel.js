...
const imgLeft = document.getElementById('img__button--left');
const imgRight = document.getElementById('img__button--right');

imgLeft.addEventListener('click', imgSlideLeft);
imgRight.addEventListener('click', imgSlideRight);
